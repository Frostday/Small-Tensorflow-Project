...
train_path_from = os.path.abspath(
    'D:/assets/data/Fruits-360/fruits-360/Training')
valid_path_from = os.path.abspath(
    'D:/assets/data/Fruits-360/fruits-360/Validation')
